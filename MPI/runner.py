...
command_line = "mpiexec --n {cores} --hostfile hostfile --display-map zcat /Infos/lmd/2019/master/ue/MU4IN903-2020fev/{matrix}.mtx.gz | ./cg_scatter --matrix {matrix}.mtx --seed {seed}"
